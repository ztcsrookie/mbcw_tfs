...
def multi_mbcw_cross_validation(normalised_x, original_y, paras, all_causal_paths, add_causal_weights, weighted_add_causal_weights, product_causal_weights):
    '''
...
if __name__ == '__main__':
    ...
    for data_set_index in range(num_data_sets):
        ...
        # cg_save_path = 'Results/CGs/mbcw_best_cgs/' + data_set_name + '_DiLi.png'
                        ...
                        try:
                            ...
                            add_product_scores, weighted_add_product_scores, product_product_scores\
                                = multi_mbcw_cross_validation(normalised_x, original_y, current_paras, all_causal_paths,
                                                              add_all_weights, weighted_add_all_weights, product_all_weights)
    ...
    # np.savetxt('Results/Performance/03_12_multi_cws_pima.csv', performance_results, delimiter=',', fmt='%.4f')